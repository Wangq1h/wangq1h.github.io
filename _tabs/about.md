...
- **成果**: 以共同一作身份发表论文，已发表在《Phys. Plasma》。

### 上海交通大学（SJTU），李政道研究所（TDLI）, 上海

**科研实践** 导师：丁洪院士，吕佰晴教授**时间**: 2023年11月 – 至今

- 学习拓扑量子计算、铁基超导和STM的理论及相关实验技能。
- 参与了Fe(Te, Se)体系中拓扑能级调控的研究，负责开发了基于Unet的STM图像识别程序，结合实验数据分析了Te掺杂与MZM产率与拓扑能带的关系。为拓扑量子计算工程化提供了重要参考。
- 参与了Fe(Se, S)体系中Pair Breaking Symmetry Inteference(PBSI)现象的研究，协助进行了实验测量以及数据分析，验证了Fe(Se, S)体系中存在的PBSI现象以及其在S掺杂过程中的变化。为第二相区的超导机理研究提供了实验证据。
...
- 上海交通大学致远荣誉奖学金（2021、2022、2023、2024）
- 上海交通大学B等学业优秀奖学金（2023、2024）
- 上海交通大学致远学院境内外研修A等奖学金（2023）
- 美国大学生数学建模竞赛Successful Participant（2022、2023）
- 2nd TOPAC优秀表现奖（2024）
- 2024年全国高校荣誉学院科研创新大赛二等奖
